                        ...
                        <tbody>
                            ...
                            <tr role="row">
                                <td><input type="checkbox" name="" class="singleSelect"
                                        data-id="{{$region->recipe_region_id}}"></td>
                                <td>
                                    {{ $region->name_en }}
                                </td>
                                <td>
                                ...
                                <td>
                                    <a class="fa fa-edit"
                                        href="{{url('dashboard/recipe/region/edit', [$region->recipe_region_id])}}"
                                        title="Edit"></a> | 
                                    <a onclick="return confirm('Are you sure? You want to delete it.')"
                                        class="fa fa-trash"
                                        href="{{url('dashboard/recipe/region/delete', [$region->recipe_region_id])}}"
                                        title="Delete"></a>
