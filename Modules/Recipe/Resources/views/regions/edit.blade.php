              ...
              <form method="post" action="{{url('dashboard/recipe/region/update',['id'=>$id])}}" enctype='multipart/form-data'>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" placeholder="Enter Name" name="name_en" min="3" max="50" value="{{ $region->name_en }}" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                  ...
                  <div class="form-group hidden">
                    ...
                    <input type="number" class="form-control" id="priority" placeholder="Enter Priority" name="priority" value="{{ $region->priority }}">
                  </div>
