                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" placeholder="Enter Title" name="title_en" min="3" max="50" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="name">Title(Italian)</label>
                        <input type="text" class="form-control" id="name" placeholder="Enter Title" name="title_it" min="3" max="50" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group ingredient_list" style="display: none">
                    ...
                    <select class="form-control" name="parent_id">
                      @foreach($tools as $tool)
                        <option value="{{ $tool->recipe_tool_id }}">{{ $tool->title_en }}</option>
                      @endforeach
                    </select>
                  </div> 
