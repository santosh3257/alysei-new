                    ...
                    <tbody>
                        @if($walkthroughs)
                            ...
                            <tr role="row">
                                ...
                                <td>
                                    <a class="fa fa-edit" href="{{url('dashboard/walkthrough/edit', [$walkthrough->walk_through_screen_id])}}"
                                        title="Edit"></a> |
                                    <a onclick="return confirm('Are you sure? You want to delete it.')" class="fa fa-trash" href="{{url('dashboard/walkthrough/delete', [$walkthrough->walk_through_screen_id])}}"
                                        title="Delete"></a>
