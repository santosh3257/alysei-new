  ...
  <div class="container-fluid">
      <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="{{url('dashboard/discover-alysei/discovery-post/store')}}" enctype='multipart/form-data'>
                {{ csrf_field() }}
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                                    ...
                                    <select class="form-control" name="country_code">
                                        @if($countries)
                                            @foreach($countries['data'] as $key=>$country)
                                                ...
                                                <option value="{{$dialCode}}">+{{$dialCode}} ({{$country['name']}})</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
