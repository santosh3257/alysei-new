...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Add Marketplace Walkthrough</h1>
      </div>
      <div class="col-sm-6">
      ...
      <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Marketplace Walkthrough</h3>
              </div>

              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="{{url('dashboard/market-place/walkthrough/store')}}" enctype='multipart/form-data'>
                {{ csrf_field() }}
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="title" placeholder="Enter Title" name="title_en" min="3" max="50">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                          <label>Description(Italian):</label>
                            <textarea name="description_it" class="form-control" required></textarea> 
                      </div>
                  </div>
                </div>
                <div class="row">
                    ...
                    <div class="bullet_point">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                              <label for="name">Title</label>
                              <input type="text" class="form-control" name="point_title_en[]" placeholder="Enter Title" name="title_en" min="3" max="50">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                              <label for="name">Title(Italian):</label>
                              <input type="text" class="form-control" name="point_title_it[]" placeholder="Enter Title" name="title_it" min="3" max="50">
                            </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                              <label>Description:</label>
                                <textarea  name="point_description_en[]" class="form-control"></textarea> 
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                              <label>Description(Italian):</label>
                                <textarea name="point_description_it[]" class="form-control"></textarea> 
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
