...
class CreateMarketplaceUserAddressTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('marketplace_user_address', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('marketplace_user_address');
    }
}
