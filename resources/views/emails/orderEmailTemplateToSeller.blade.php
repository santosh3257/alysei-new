                  ...
                  <tbody>
                    <tr>
                      <td valign="top">
                        ...
                        <p style="font-size: 1rem; font-weight: 600; margin: 0.5rem 0;">You have received this order by {{ $order->buyerInfo->company_name }}.</p>
                      </td>
                    </tr>
                  </tbody>
                </table>
                  ...
                  <tbody>
                    <tr>
                      <td valign="top" width="100" style="text-align:right;font-size: 1rem;">
                        <h4 style="margin:4px;font-size: 1rem;"><span style="font-weight: 600;">Importer Name:</span> {{$user['company_name']}}</h4>
                        <p style="margin:4px; font-size: 1rem; font-weight: 400;"><span style="font-weight: 600;">Email:</span> <span>{{$user['email']}}</span></p>
                        <p style="margin:4px; font-size: 1rem; font-weight: 400;"><span style="font-weight: 600;">Phone Number:</span> <span>+{{$user['country_code']}} {{$user['phone']}}</span></p>
                      </td>
                    </tr>
                  </tbody>
                </table>
