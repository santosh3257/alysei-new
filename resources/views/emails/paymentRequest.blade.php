              ...
              <td style="margin:0;padding:0">
                ...
                <table width="100%"
                  ...
                  <tbody>
                    <tr>
                      <td valign="top">
                        <h4 style="font-size: 1.01rem; font-weight: 600; margin: 0.5rem 0;">Action needed!</h4>
                        <p style="font-size: 1rem; font-weight: 600; margin: 0.5rem 0;">{{ $order->sellerInfo->company_name }} has requested the payment for this order.</p>
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table style="width: 100%; border-collapse: collapse;">
                  ...
                  <tfoot>
                    ...
                    <tr>
                      <td scope="row" colspan="3"
                      style="border: 1px solid #ddd; font-size: 1rem; font-weight: 600; text-align: left; padding: 0.5rem;text-align: right;">
                      Total amount you need to pay after deducting 10%</td>
                      <td style="border: 1px solid #ddd; font-size: 1rem; font-weight: 600; text-align: left; padding: 0.5rem;text-align: right;">{{$order->currency.$payAmount}}</td>
                    </tr>
                  </tfoot>
                </table>
