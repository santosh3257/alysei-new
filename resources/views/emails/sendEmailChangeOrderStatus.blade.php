              ...
              <td style="margin:0;padding:0">
                ...
                <table width="100%"
                  ...
                  <tbody>
                    ...
                    @if($order->status == 'cancelled')
                      <td valign="top">
                        <p style="font-size: 1rem; font-weight: 600; margin: 0.5rem 0;">Your order has been cancelled by the producer. if you have any query about it please discuss with him. Thanks</p>
                      </td>
                    @elseif($order->status == 'processing')
                        <td valign="top">
                        <h4 style="font-size: 1.01rem; font-weight: 600; margin: 0.5rem 0;">Congratulations!</h4>
                        <p style="font-size: 1rem; font-weight: 600; margin: 0.5rem 0;">Your order has been accepted by {{ $order->sellerInfo->company_name }}.</p>
                      </td>
                    @else
                      <td valign="top">
                        <h4 style="font-size: 1.01rem; font-weight: 600; margin: 0.5rem 0;">Congratulations!</h4>
                        <p style="font-size: 1rem; font-weight: 600; margin: 0.5rem 0;">Your order has changed the status to completed</p>
                      </td>
                    @endif
                    </tr>
                  </tbody>
                ...
                <table style="width: 100%; border-collapse: collapse;">
                  <tbody>
                    <tr>
                      ...
                      <td style="font-size: 1.25rem; font-weight: 600; padding: 0.5rem; padding-right: 0; text-align: right;">Order Date: {{$order->created_at}}</td>
                    </tr>
                    @if(!empty($offerInfo))
                    <tr>
                      <td colspan="3" style="font-size: 1rem; font-weight: 600; padding: 0.5rem; padding-left: 0;">Offer Name: {{$offerInfo->offer_title}}</td>
                ...
                <table width="100%"
                  ...
                  <tbody>
                    <tr>
                      <td valign="top">
                        <h4 style="font-size: 1.25rem; font-weight: 600; margin: 0.5rem 0;">Billing Details</h4>
