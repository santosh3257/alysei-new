                 ...
                 <tr> 
                  ...
                  <table border="0" cellpadding="20" cellspacing="0" width="100%"
                   ...
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr> 
                     <td align="left" class="es-m-p0r es-m-p0l" style="padding:10px;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:22px;color:#333333;font-size:22px">Congratulations!!<br><br>You have received a connection request from an Alysei Member!<br><br>Open the Alysei App on your phone and start a new collaboration for your business.<br><br><a href="{{$connection->directLink}}" target="_blank"><button class="btn" type="button">View Connection</button></a><br><br>Team Alysei
                      </td> 
                      <!-- <td align="left" class="es-m-p0r es-m-p0l" style="padding:10px;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:22px;color:#333333;font-size:22px">Congratulations!!<br><br>You have received a connection request from an Alysei Member!<br>Open the Alysei App on your phone and start a new collaboration for your business.
                        Hi {{ $user['company_name'] }},<br><br>You have a new connection request from {{ $sender['company_name'] }} in Alysei.<br><br><a href="{{$connection->directLink}}" target="_blank"><button class="btn" type="button">View Connection</button></a><br><br>Team Alysei
                      </td>  -->
                     </tr> 
                   </table></td> 
                 </tr> 
