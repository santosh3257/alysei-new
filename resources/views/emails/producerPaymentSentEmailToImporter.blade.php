              ...
              <td style="margin:0;padding:0">
                ...
                <table width="100%"
                  ...
                  <tbody>
                    <tr>
                      <td valign="top">
                        <h4 style="font-size: 1.01rem; font-weight: 600; margin: 0.5rem 0;">Attention!</h4>
                        <p style="font-size: 1rem; font-weight: 600; margin: 0.5rem 0;">{{ $order->sellerInfo->company_name }} requested the payment to Alysei for this order.</p>
                      </td>
                    </tr>
                  </tbody>
                </table>
